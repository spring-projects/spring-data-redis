...
/**
 * A {@link RedisListenerEndpoint} simply providing the {@link MessageListener} to invoke to process an incoming message
 * for this endpoint.
 *
 * @author Mark Paluch
 * @since 4.1
...
public class SimpleRedisListenerEndpoint extends AbstractRedisListenerEndpoint {
	...
	public SimpleRedisListenerEndpoint(MessageListener messageListener) {
