 ...
 */
@NullUnmarked
class JedisClientClusterServerCommands implements RedisClusterServerCommands {

	private final JedisClientClusterConnection connection;

	JedisClientClusterServerCommands(@NonNull JedisClientClusterConnection connection) {
