...
public interface DefaultedRedisConnection extends RedisCommands, RedisCommandsProvider {
	...
	@Override
	@Deprecated
	default Boolean set(byte[] key, byte[] value, Expiration expiration, SetCondition condition) {
		return stringCommands().set(key, value, expiration, condition);
	}
	...
	@Override
	@Deprecated
	default byte[] setGet(byte[] key, byte[] value, Expiration expiration, SetCondition condition) {
		return stringCommands().setGet(key, value, expiration, condition);
	}
