 ...
 */
@NullUnmarked
class JedisClientClusterListCommands implements RedisListCommands {

	private final JedisClientClusterConnection connection;

	JedisClientClusterListCommands(@NonNull JedisClientClusterConnection connection) {
	...
	public Long rPush(byte @NonNull [] key, byte @NonNull [] @NonNull... values) {
		...
		try {
			return connection.getClusterClient().rpush(key, values);
		} catch (Exception ex) {
	...
	public List<Long> lPos(byte @NonNull [] key, byte @NonNull [] element, @Nullable Integer rank,
		...
		try {
			...
			if (count != null) {
				return connection.getClusterClient().lpos(key, element, params, count);
			}

			Long value = connection.getClusterClient().lpos(key, element, params);
	...
	public Long lPush(byte @NonNull [] key, byte @NonNull [] @NonNull... values) {
		...
		try {
			return connection.getClusterClient().lpush(key, values);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Long rPushX(byte @NonNull [] key, byte @NonNull [] value) {
		...
		try {
			return connection.getClusterClient().rpushx(key, value);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Long lPushX(byte @NonNull [] key, byte @NonNull [] value) {
		...
		try {
			return connection.getClusterClient().lpushx(key, value);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Long lLen(byte @NonNull [] key) {
		...
		try {
			return connection.getClusterClient().llen(key);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public List<byte @NonNull []> lRange(byte @NonNull [] key, long start, long end) {
		...
		try {
			return connection.getClusterClient().lrange(key, start, end);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public void lTrim(byte @NonNull [] key, long start, long end) {
		...
		try {
			connection.getClusterClient().ltrim(key, start, end);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public byte[] lIndex(byte @NonNull [] key, long index) {
		...
		try {
			return connection.getClusterClient().lindex(key, index);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Long lInsert(byte @NonNull [] key, @NonNull Position where, byte @NonNull [] pivot, byte @NonNull [] value) {
		...
		try {
			return connection.getClusterClient().linsert(key, JedisConverters.toListPosition(where), pivot, value);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public byte[] lMove(byte @NonNull [] sourceKey, byte @NonNull [] destinationKey, @NonNull Direction from,
		...
		try {
			return connection.getClusterClient().lmove(sourceKey, destinationKey, ListDirection.valueOf(from.name()),
	...
	public byte[] bLMove(byte @NonNull [] sourceKey, byte @NonNull [] destinationKey, @NonNull Direction from,
		...
		try {
			return connection.getClusterClient().blmove(sourceKey, destinationKey, ListDirection.valueOf(from.name()),
	...
	public void lSet(byte @NonNull [] key, long index, byte @NonNull [] value) {
		...
		try {
			connection.getClusterClient().lset(key, index, value);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Long lRem(byte @NonNull [] key, long count, byte @NonNull [] value) {
		...
		try {
			return connection.getClusterClient().lrem(key, count, value);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public byte[] lPop(byte @NonNull [] key) {
		...
		try {
			return connection.getClusterClient().lpop(key);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public List<byte @NonNull []> lPop(byte @NonNull [] key, long count) {
		...
		try {
			return connection.getClusterClient().lpop(key, (int) count);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public byte[] rPop(byte @NonNull [] key) {
		...
		try {
			return connection.getClusterClient().rpop(key);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public List<byte @NonNull []> rPop(byte @NonNull [] key, long count) {
		...
		try {
			return connection.getClusterClient().rpop(key, (int) count);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public List<byte @NonNull []> bLPop(int timeout, byte @NonNull [] @NonNull... keys) {
		...
		if (ClusterSlotHashUtil.isSameSlotForAllKeys(keys)) {
			try {
				return connection.getClusterClient().blpop(timeout, keys);
			} catch (Exception ex) {
				throw convertJedisAccessException(ex);
			}
		}
	...
	public List<byte @NonNull []> bRPop(int timeout, byte @NonNull [] @NonNull... keys) {
		...
		if (ClusterSlotHashUtil.isSameSlotForAllKeys(keys)) {
			try {
				return connection.getClusterClient().brpop(timeout, keys);
			} catch (Exception ex) {
				throw convertJedisAccessException(ex);
			}
		}
	...
	public byte[] rPopLPush(byte @NonNull [] srcKey, byte @NonNull [] dstKey) {
		...
		if (ClusterSlotHashUtil.isSameSlotForAllKeys(srcKey, dstKey)) {
			try {
				return connection.getClusterClient().rpoplpush(srcKey, dstKey);
			} catch (Exception ex) {
				throw convertJedisAccessException(ex);
			}
		}
	...
	public byte[] bRPopLPush(int timeout, byte @NonNull [] srcKey, byte @NonNull [] dstKey) {
		...
		if (ClusterSlotHashUtil.isSameSlotForAllKeys(srcKey, dstKey)) {
			try {
				return connection.getClusterClient().brpoplpush(srcKey, dstKey, timeout);
			} catch (Exception ex) {
				throw convertJedisAccessException(ex);
			}
		}
