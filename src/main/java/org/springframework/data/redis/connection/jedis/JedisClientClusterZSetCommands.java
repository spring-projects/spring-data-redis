...
class JedisClientClusterZSetCommands implements RedisZSetCommands {
	...
	JedisClientClusterZSetCommands(@NonNull JedisClientClusterConnection connection) {
	...
	public Boolean zAdd(byte @NonNull [] key, double score, byte @NonNull [] value, @NonNull ZAddArgs args) {
		...
		try {
			return JedisConverters
					.toBoolean(connection.getClusterClient().zadd(key, score, value, JedisConverters.toZAddParams(args)));
		} catch (Exception ex) {
	...
	public Long zRem(byte @NonNull [] key, byte @NonNull [] @NonNull... values) {
		...
		try {
			return connection.getClusterClient().zrem(key, values);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	...
	public Double zIncrBy(byte @NonNull [] key, double increment, byte @NonNull [] value) {
		...
		try {
			return connection.getClusterClient().zincrby(key, increment, value);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public byte[] zRandMember(byte @NonNull [] key) {
		...
		try {
			return connection.getClusterClient().zrandmember(key);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public List<byte[]> zRandMember(byte @NonNull [] key, long count) {
		...
		try {
			return new ArrayList<>(connection.getClusterClient().zrandmember(key, count));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Tuple zRandMemberWithScore(byte @NonNull [] key) {
		...
		try {
			List<redis.clients.jedis.resps.Tuple> tuples = connection.getClusterClient().zrandmemberWithScores(key, 1);
	...
	public List<Tuple> zRandMemberWithScore(byte @NonNull [] key, long count) {
		...
		try {
			List<redis.clients.jedis.resps.Tuple> tuples = connection.getClusterClient().zrandmemberWithScores(key, count);
	...
	public Long zRank(byte @NonNull [] key, byte @NonNull [] value) {
		...
		try {
			return connection.getClusterClient().zrank(key, value);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Long zRevRank(byte @NonNull [] key, byte @NonNull [] value) {
		...
		try {
			return connection.getClusterClient().zrevrank(key, value);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Set<byte @NonNull []> zRange(byte @NonNull [] key, long start, long end) {
		...
		try {
			return new LinkedHashSet<>(connection.getClusterClient().zrange(key, start, end));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Set<Tuple> zRangeByScoreWithScores(byte @NonNull [] key,
		...
		try {
			...
			return toTupleSet(
					connection.getClusterClient().zrangeByScoreWithScores(key, min, max, limit.getOffset(), limit.getCount()));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Set<byte[]> zRevRangeByScore(byte @NonNull [] key,
		...
		try {
			if (limit.isUnlimited()) {
				return new LinkedHashSet<>(connection.getClusterClient().zrevrangeByScore(key, max, min));
			}
			return new LinkedHashSet<>(
					connection.getClusterClient().zrevrangeByScore(key, max, min, limit.getOffset(), limit.getCount()));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Set<Tuple> zRevRangeByScoreWithScores(byte @NonNull [] key,
		...
		try {
			if (limit.isUnlimited()) {
				return toTupleSet(connection.getClusterClient().zrevrangeByScoreWithScores(key, max, min));
			}
			return toTupleSet(
					connection.getClusterClient().zrevrangeByScoreWithScores(key, max, min, limit.getOffset(), limit.getCount()));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Long zCount(byte @NonNull [] key,
		...
		try {
			return connection.getClusterClient().zcount(key, min, max);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Long zLexCount(byte @NonNull [] key, org.springframework.data.domain.@NonNull Range<byte[]> range) {
		...
		try {
			return connection.getClusterClient().zlexcount(key, min, max);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Tuple zPopMin(byte @NonNull [] key) {
		...
		try {
			redis.clients.jedis.resps.Tuple tuple = connection.getClusterClient().zpopmin(key);
	...
	public Set<Tuple> zPopMin(byte @NonNull [] key, long count) {
		...
		try {
			return toTupleSet(connection.getClusterClient().zpopmin(key, Math.toIntExact(count)));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Tuple bZPopMin(byte @NonNull [] key, long timeout, @NonNull TimeUnit unit) {
		...
		try {
			return toTuple(connection.getClusterClient().bzpopmin(JedisConverters.toSeconds(timeout, unit), key));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Tuple zPopMax(byte @NonNull [] key) {
		...
		try {
			redis.clients.jedis.resps.Tuple tuple = connection.getClusterClient().zpopmax(key);
			return tuple != null ? JedisConverters.toTuple(tuple) : null;
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	...
	public Set<Tuple> zPopMax(byte @NonNull [] key, long count) {
		...
		try {
			return toTupleSet(connection.getClusterClient().zpopmax(key, Math.toIntExact(count)));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Tuple bZPopMax(byte @NonNull [] key, long timeout, @NonNull TimeUnit unit) {
		...
		try {
			return toTuple(connection.getClusterClient().bzpopmax(JedisConverters.toSeconds(timeout, unit), key));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Long zRemRangeByScore(byte @NonNull [] key,
		...
		try {
			return connection.getClusterClient().zremrangeByScore(key, min, max);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	...
	public Set<byte[]> zRangeByScore(byte @NonNull [] key,
		...
		try {
			...
			return new LinkedHashSet<>(
					connection.getClusterClient().zrangeByScore(key, min, max, limit.getOffset(), limit.getCount()));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Set<byte @NonNull []> zRangeByLex(byte @NonNull [] key,
		...
		try {
			if (limit.isUnlimited()) {
				return new LinkedHashSet<>(connection.getClusterClient().zrangeByLex(key, min, max));
			}
			return new LinkedHashSet<>(
					connection.getClusterClient().zrangeByLex(key, min, max, limit.getOffset(), limit.getCount()));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Long zRemRangeByLex(byte @NonNull [] key, org.springframework.data.domain.@NonNull Range<byte[]> range) {
		...
		try {
			return connection.getClusterClient().zremrangeByLex(key, min, max);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Set<byte @NonNull []> zRevRangeByLex(byte @NonNull [] key,
		...
		try {
			if (limit.isUnlimited()) {
				return new LinkedHashSet<>(connection.getClusterClient().zrevrangeByLex(key, max, min));
			}
			return new LinkedHashSet<>(
					connection.getClusterClient().zrevrangeByLex(key, max, min, limit.getOffset(), limit.getCount()));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	private Long zRangeStoreByLex(byte @NonNull [] dstKey, byte @NonNull [] srcKey,
		...
		try {
			return connection.getClusterClient().zrangestore(dstKey, srcKey, zRangeParams);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Set<@NonNull Tuple> zRangeWithScores(byte @NonNull [] key, long start, long end) {
		...
		try {
			return toTupleSet(connection.getClusterClient().zrangeWithScores(key, start, end));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Set<byte @NonNull []> zRevRange(byte @NonNull [] key, long start, long end) {
		...
		try {
			return new LinkedHashSet<>(connection.getClusterClient().zrevrange(key, start, end));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Set<@NonNull Tuple> zRevRangeWithScores(byte @NonNull [] key, long start, long end) {
		...
		try {
			return toTupleSet(connection.getClusterClient().zrevrangeWithScores(key, start, end));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Long zCard(byte @NonNull [] key) {
		...
		try {
			return connection.getClusterClient().zcard(key);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Double zScore(byte @NonNull [] key, byte @NonNull [] value) {
		...
		try {
			return connection.getClusterClient().zscore(key, value);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public List<Double> zMScore(byte @NonNull [] key, byte @NonNull [] @NonNull [] values) {
		...
		try {
			return connection.getClusterClient().zmscore(key, values);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Long zRemRange(byte @NonNull [] key, long start, long end) {
		...
		try {
			return connection.getClusterClient().zremrangeByRank(key, start, end);
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Set<byte @NonNull []> zDiff(byte @NonNull [] @NonNull... sets) {
		...
		if (ClusterSlotHashUtil.isSameSlotForAllKeys(sets)) {
			...
			try {
				return JedisConverters.toSet(connection.getClusterClient().zdiff(sets));
			} catch (Exception ex) {
				throw convertJedisAccessException(ex);
			}
		}
	...
	public Set<Tuple> zDiffWithScores(byte @NonNull [] @NonNull... sets) {
		...
		if (ClusterSlotHashUtil.isSameSlotForAllKeys(sets)) {
			...
			try {
				return JedisConverters.toSet(JedisConverters.toTupleList(connection.getClusterClient().zdiffWithScores(sets)));
			} catch (Exception ex) {
				throw convertJedisAccessException(ex);
			}
		}
	...
	public Set<byte @NonNull []> zInter(byte @NonNull [] @NonNull... sets) {
		...
		if (ClusterSlotHashUtil.isSameSlotForAllKeys(sets)) {
			...
			try {
				return JedisConverters.toSet(connection.getClusterClient().zinter(new ZParams(), sets));
			} catch (Exception ex) {
				throw convertJedisAccessException(ex);
			}
		}
	...
	public Set<@NonNull Tuple> zInterWithScores(byte @NonNull [] @NonNull... sets) {
		...
		if (ClusterSlotHashUtil.isSameSlotForAllKeys(sets)) {
			...
			try {
				return JedisConverters
						.toSet(JedisConverters.toTupleList(connection.getClusterClient().zinterWithScores(new ZParams(), sets)));
			} catch (Exception ex) {
				throw convertJedisAccessException(ex);
			}
		}
	...
	public Long zInterStore(byte @NonNull [] destKey, byte @NonNull [] @NonNull... sets) {
		...
		if (ClusterSlotHashUtil.isSameSlotForAllKeys(allKeys)) {
			...
			try {
				return connection.getClusterClient().zinterstore(destKey, sets);
			} catch (Exception ex) {
				throw convertJedisAccessException(ex);
			}
		}
	...
	public Long zInterStore(byte @NonNull [] destKey, @NonNull Aggregate aggregate, @NonNull Weights weights,
		...
		if (ClusterSlotHashUtil.isSameSlotForAllKeys(allKeys)) {
			...
			try {
				return connection.getClusterClient().zinterstore(destKey, toZParams(aggregate, weights), sets);
			} catch (Exception ex) {
				throw convertJedisAccessException(ex);
			}
		}
	...
	public Set<byte @NonNull []> zUnion(byte @NonNull [] @NonNull... sets) {
		...
		if (ClusterSlotHashUtil.isSameSlotForAllKeys(sets)) {
			...
			try {
				return JedisConverters.toSet(connection.getClusterClient().zunion(new ZParams(), sets));
			} catch (Exception ex) {
				throw convertJedisAccessException(ex);
			}
		}
	...
	public Set<@NonNull Tuple> zUnionWithScores(byte @NonNull [] @NonNull... sets) {
		...
		if (ClusterSlotHashUtil.isSameSlotForAllKeys(sets)) {
			...
			try {
				return JedisConverters
						.toSet(JedisConverters.toTupleList(connection.getClusterClient().zunionWithScores(new ZParams(), sets)));
			} catch (Exception ex) {
				throw convertJedisAccessException(ex);
			}
		}
	...
	public Long zUnionStore(byte @NonNull [] destKey, byte @NonNull [] @NonNull... sets) {
		...
		if (ClusterSlotHashUtil.isSameSlotForAllKeys(allKeys)) {
			...
			try {
				return connection.getClusterClient().zunionstore(destKey, sets);
			} catch (Exception ex) {
				throw convertJedisAccessException(ex);
			}
		}
	...
	public Long zUnionStore(byte @NonNull [] destKey, @NonNull Aggregate aggregate, @NonNull Weights weights,
		...
		if (ClusterSlotHashUtil.isSameSlotForAllKeys(allKeys)) {
			...
			try {
				return connection.getClusterClient().zunionstore(destKey, zparams, sets);
			} catch (Exception ex) {
				throw convertJedisAccessException(ex);
			}
		}
	...
	public Cursor<@NonNull Tuple> zScan(byte @NonNull [] key, ScanOptions options) {
		...
		return new ScanCursor<Tuple>(options) {
			...
			protected ScanIteration<@NonNull Tuple> doScan(@NonNull CursorId cursorId, @NonNull ScanOptions options) {
				...
				ScanResult<redis.clients.jedis.resps.Tuple> result = connection.getClusterClient().zscan(key,
	...
	public Set<byte @NonNull []> zRangeByScore(byte @NonNull [] key, @NonNull String min, @NonNull String max) {
		...
		try {
			return new LinkedHashSet<>(
					connection.getClusterClient().zrangeByScore(key, JedisConverters.toBytes(min), JedisConverters.toBytes(max)));
		} catch (Exception ex) {
			throw convertJedisAccessException(ex);
		}
	}
	...
	public Set<byte @NonNull []> zRangeByScore(byte @NonNull [] key, @NonNull String min, @NonNull String max,
		...
		try {
			return new LinkedHashSet<>(connection.getClusterClient().zrangeByScore(key, JedisConverters.toBytes(min),
