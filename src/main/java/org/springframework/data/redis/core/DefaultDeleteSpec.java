 ...
 * @since 4.1
 */
class DefaultDeleteSpec<K, V> implements DeleteSpec<K, V>, DeleteSpec.ComparisonSpec<K, V> {
	...
	@Override
	public DeleteSpec<K, V> value(V value) {
	...
	@Override
	public DeleteSpec<K, V> digest(String hex16) {
