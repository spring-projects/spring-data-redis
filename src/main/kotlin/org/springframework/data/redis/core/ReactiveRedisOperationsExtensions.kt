...
/**
 * Coroutines variant of [ReactiveValueOperations.delete] allowing to customize the operation through [DeleteSpec].
 *
 * @author Mark Paluch
 * @since 4.1
 */
suspend fun <K : Any, V : Any> ReactiveRedisOperations<K, V>.deleteAndAwait(
	key: K, builderCustomizer: Consumer<DeleteSpec<K, V>>
