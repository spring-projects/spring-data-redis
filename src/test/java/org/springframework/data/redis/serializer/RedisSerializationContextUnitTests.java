...
class RedisSerializationContextUnitTests {
	...
	void shouldEncodeAndDecodeRawByteBufferValue() {
		...
		ByteBuffer deserialized = serializationContext.getValueSerializationPair()
				.read(serializationContext.getValueSerializationPair().write(ByteBuffer.wrap("hello".getBytes())));
	...
	void shouldEncodeAndDecodeUtf8StringValue() {
		...
		RedisSerializationContext.SerializationPair<String> serializationPair = buildStringSerializationContext(
				StringRedisSerializer.UTF_8).getStringSerializationPair();
	...
	void shouldEncodeAndDecodeAsciiStringValue() {
		...
		RedisSerializationContext.SerializationPair<String> serializationPair = buildStringSerializationContext(
				StringRedisSerializer.US_ASCII).getStringSerializationPair();
	...
	void shouldEncodeAndDecodeIso88591StringValue() {
		...
		RedisSerializationContext.SerializationPair<String> serializationPair = buildStringSerializationContext(
				StringRedisSerializer.ISO_8859_1).getStringSerializationPair();
	...
	private RedisSerializationContext<String, String> buildStringSerializationContext(
		...
		return RedisSerializationContext.<String, String> newSerializationContext(stringSerializer).string(stringSerializer)
				.build();
	}
}
