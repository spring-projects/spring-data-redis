...
public class RedisCacheManagerIntegrationTests {
	...
	public void testCacheIsNotDecoratedTwiceWithTransactionAwareCacheDecorator() {
		...
		Assert.assertTrue(cache instanceof TransactionAwareCacheDecorator);
		...
		Assert.assertTrue(targetCache instanceof RedisCache);
	}
}
