...
public class DefaultStringRedisConnectionPipelineTxTests extends
		DefaultStringRedisConnectionTxTests {
	...
	public void testBlPopBytes() {
		doReturn(Arrays.asList(new Object[] {Arrays.asList(new Object[] { bytesList })})).when(nativeConnection).closePipeline();
	...
	public void testGetConfig() {
		...
		doReturn(Arrays.asList(new Object[] {Arrays.asList(new Object[] { results })})).when(nativeConnection).closePipeline();
		super.testGetConfig();
	}

	@Test
	public void testGetNativeConnection() {
		doReturn(Arrays.asList(new Object[] {Arrays.asList(new Object[] { "foo" })})).when(nativeConnection).closePipeline();
	...
	public void testHGetAllBytes() {
		doReturn(Arrays.asList(new Object[] {Arrays.asList(new Object[] { bytesMap })})).when(nativeConnection).closePipeline();
	...
	public void testHKeysBytes() {
		doReturn(Arrays.asList(new Object[] {Arrays.asList(new Object[] { bytesSet })})).when(nativeConnection).closePipeline();
	...
	public void testInfo() {
		...
		props.put("foo", "bar");
		doReturn(Arrays.asList(new Object[] {Arrays.asList(new Object[] { props })})).when(nativeConnection).closePipeline();
		super.testInfo();
	}
	...
	public void testPing() {
		doReturn(Arrays.asList(new Object[] {Arrays.asList(new Object[] { "pong" })})).when(nativeConnection).closePipeline();
		super.testPing();
	}
	...
	public void testZRangeByScoreWithScoresOffsetCountBytes() {
		doReturn(Arrays.asList(new Object[] {Arrays.asList(new Object[] { tupleSet })})).when(nativeConnection).closePipeline();
	...
	public void testTxResultsNotSameSizeAsResults() {
		...
		// while tx is open
		doReturn(Arrays.asList(new Object[] {Arrays.asList(new Object[] { barBytes, 3l })})).when(nativeConnection).closePipeline();
	...
	public void testTwoTxs() {
		doReturn(Arrays.asList(new Object[] {Arrays.asList(new Object[] { barBytes }),
				Arrays.asList(new Object[] { fooBytes })})).when(nativeConnection).closePipeline();
		connection.get(foo);
		connection.exec();
		connection.get(bar);
		connection.exec();
		List<Object> results =  connection.closePipeline();
		assertEquals(Arrays.asList(new Object[] {Arrays.asList(new Object[] { bar }),
				Arrays.asList(new Object[] { foo })}), results);
	}
