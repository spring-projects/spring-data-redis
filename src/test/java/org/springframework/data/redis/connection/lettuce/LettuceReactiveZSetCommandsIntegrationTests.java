...
public class LettuceReactiveZSetCommandsIntegrationTests extends LettuceReactiveCommandsTestSupport {
	...
	void zAddShouldConsiderAbsentPresentUpsertFlags() {
		...
		Tuple tuple = new DefaultTuple(VALUE_1_BYTES, 3.5D);
		...
		// XX
		zAdd(KEY_1_BBUFFER, new DefaultTuple(VALUE_1_BYTES, 3.0D), ZAddCommand::xx).map(Number::intValue) //
				.as(StepVerifier::create) //
				.expectNext(0) //
				.verifyComplete();
	...
	void zAddShouldConsiderLessThan() {
		...
		zAdd(KEY_1_BBUFFER, new DefaultTuple(VALUE_1_BYTES, 6D), ZAddCommand::lt).map(Number::intValue) //
				.as(StepVerifier::create) //
				.expectNext(0) //
				.verifyComplete();
		...
		zAdd(KEY_1_BBUFFER, new DefaultTuple(VALUE_1_BYTES, 1D), ZAddCommand::lt).map(Number::intValue) //
				.as(StepVerifier::create) //
				.expectNext(0) //
				.verifyComplete();
	...
	void zAddShouldConsiderGreaterThan() {
		...
		zAdd(KEY_1_BBUFFER, new DefaultTuple(VALUE_1_BYTES, 1D), ZAddCommand::gt).map(Number::intValue) //
				.as(StepVerifier::create) //
				.expectNext(0) //
				.verifyComplete();
		...
		zAdd(KEY_1_BBUFFER, new DefaultTuple(VALUE_1_BYTES, 6D), ZAddCommand::gt).map(Number::intValue) //
				.as(StepVerifier::create) //
				.expectNext(0) //
				.verifyComplete();
	...
	void zAddShouldConsiderChFlag() {
		...
		zAdd(KEY_1_BBUFFER, new DefaultTuple(VALUE_1_BYTES, 3.0D), ZAddCommand::ch).map(Number::intValue) //
				.as(StepVerifier::create) //
				.expectNext(1) //
				.verifyComplete();
	}
