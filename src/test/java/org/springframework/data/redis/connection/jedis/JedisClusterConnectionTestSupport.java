...
public abstract class JedisClusterConnectionTestSupport implements ClusterConnectionTests {
	...
	private final UnifiedJedis nativeConnection;
	private final JedisClusterConnection clusterConnection;

	protected JedisClusterConnectionTestSupport(UnifiedJedis nativeConnection, JedisClusterConnection clusterConnection) {
	...
	void bitFieldSetShouldWorkCorrectly() {
		...
		assertThat(clusterConnection.stringCommands().bitField(JedisConverters.toBytes(KEY_1),
				create().set(INT_8).valueAt(Offset.offset(0L)).to(10L))).containsExactly(0L);
		assertThat(clusterConnection.stringCommands().bitField(JedisConverters.toBytes(KEY_1),
				create().set(INT_8).valueAt(Offset.offset(0L)).to(20L))).containsExactly(10L);
	}
	...
	void bitFieldGetShouldWorkCorrectly() {
		...
		assertThat(clusterConnection.stringCommands().bitField(JedisConverters.toBytes(KEY_1),
				create().get(INT_8).valueAt(Offset.offset(0L)))).containsExactly(0L);
	}
	...
	void bitFieldIncrByShouldWorkCorrectly() {
		...
		assertThat(clusterConnection.stringCommands().bitField(JedisConverters.toBytes(KEY_1),
				create().incr(INT_8).valueAt(Offset.offset(100L)).by(1L))).containsExactly(1L);
	}
	...
	void bitFieldIncrByWithOverflowShouldWorkCorrectly() {
		...
		assertThat(clusterConnection.stringCommands().bitField(JedisConverters.toBytes(KEY_1),
				create().incr(unsigned(2)).valueAt(Offset.offset(102L)).overflow(FAIL).by(1L))).containsExactly(1L);
		assertThat(clusterConnection.stringCommands().bitField(JedisConverters.toBytes(KEY_1),
				create().incr(unsigned(2)).valueAt(Offset.offset(102L)).overflow(FAIL).by(1L))).containsExactly(2L);
		assertThat(clusterConnection.stringCommands().bitField(JedisConverters.toBytes(KEY_1),
				create().incr(unsigned(2)).valueAt(Offset.offset(102L)).overflow(FAIL).by(1L))).containsExactly(3L);
		assertThat(clusterConnection.stringCommands().bitField(JedisConverters.toBytes(KEY_1),
				create().incr(unsigned(2)).valueAt(Offset.offset(102L)).overflow(FAIL).by(1L)).get(0)).isNull();
	}
	...
	void bitfieldShouldAllowMultipleSubcommands() {
		...
		assertThat(clusterConnection.stringCommands().bitField(JedisConverters.toBytes(KEY_1),
				create().incr(signed(5)).valueAt(Offset.offset(100L)).by(1L).get(unsigned(4)).valueAt(0L)))
	...
	void bitfieldShouldWorkUsingNonZeroBasedOffset() {
		...
		assertThat(clusterConnection.stringCommands().bitField(JedisConverters.toBytes(KEY_1),
				create().set(INT_8).valueAt(Offset.offset(0L).multipliedByTypeLength()).to(100L).set(INT_8)
						.valueAt(Offset.offset(1L).multipliedByTypeLength()).to(200L)))
				.containsExactly(0L, 0L);
		assertThat(clusterConnection.stringCommands().bitField(JedisConverters.toBytes(KEY_1),
				create().get(INT_8).valueAt(Offset.offset(0L).multipliedByTypeLength()).get(INT_8)
						.valueAt(Offset.offset(1L).multipliedByTypeLength())))
	...
	void setWithIfAbsentConditionShouldSetWhenKeyDoesNotExist() {
		...
		Boolean result = clusterConnection.set(KEY_1_BYTES, VALUE_1_BYTES, SetCondition.ifAbsent(),
	...
	void setWithIfAbsentConditionShouldNotSetWhenKeyExist() {
		...
		Boolean result = clusterConnection.set(KEY_1_BYTES, VALUE_2_BYTES, SetCondition.ifAbsent(),
				Expiration.persistent());
	...
	void setWithIfPresentConditionShouldSetWhenKeyExist() {
		...
		Boolean result = clusterConnection.set(KEY_1_BYTES, VALUE_2_BYTES, SetCondition.ifPresent(),
				Expiration.persistent());
	...
	void setWithIfPresentConditionShouldNotSetWhenKeyDoesNotExist() {
		...
		Boolean result = clusterConnection.set(KEY_1_BYTES, VALUE_1_BYTES, SetCondition.ifPresent(),
				Expiration.persistent());
	...
	void setWithIfEqualsConditionShouldSetWhenValueMatch() {
		...
		Boolean result = clusterConnection.set(KEY_1_BYTES, VALUE_2_BYTES, SetCondition.ifEquals(VALUE_1_BYTES),
				Expiration.persistent());
	...
	void setWithIfEqualsConditionShouldNotSetWhenValueDoesNotMatch() {
		...
		Boolean result = clusterConnection.set(KEY_1_BYTES, VALUE_2_BYTES, SetCondition.ifEquals(VALUE_2_BYTES),
				Expiration.persistent());
